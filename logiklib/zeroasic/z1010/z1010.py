...
####################################################
# Setup for z1010 FPGA
####################################################

class z1010(YosysFPGA, VPRFPGA, OpenSTAFPGA):
    '''
    Logik driver for z1010
    '''
    ...
    def __init__(self):
        ...
        register_part_data(self, "logik-fpga-z1010", 'z1010')

        self.package.set_vendor("fpga_architect")

        self.set_vpr_devicecode("z1010")
