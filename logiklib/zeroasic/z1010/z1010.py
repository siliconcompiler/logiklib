...
def setup():
    ...
    fpga.set('fpga', part_name, 'file', 'archfile', 'cad/z1010.xml')
    fpga.set('fpga', part_name, 'file', 'graphfile', 'cad/z1010_rr_graph.xml')
    fpga.set('fpga', part_name, 'file', 'yosys_fpga_config', 'cad/z1010_yosys_config.json')
    ...
    fpga.set('fpga', part_name, 'file', 'bitstream_map', 'cad/z1010_bitstream_map.json')

    fpga.set('fpga', part_name, 'file', 'constraints_map', 'cad/z1010_constraint_map.json')
